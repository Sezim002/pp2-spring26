...
CALL upsert_contact('Sezim', '877675642556');
CALL upsert_contact('Simona', '8545556');
CALL upsert_contact('Sim', '87756');
CALL upsert_contact('Seezez', '75642556');
...
--search by patterns
SELECT get_contacts_by_patterns('776');
--insert with array
CALL insert_new_users(ARRAY['dfghjkl', 'qwerty', 'mnbvcx'], ARRAY['7415254','8515251296','4548525']);
SELECT * FROM phonebook;
-- deleting
